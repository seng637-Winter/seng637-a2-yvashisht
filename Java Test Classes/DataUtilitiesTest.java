...
public class DataUtilitiesTest extends DataUtilities {
	...
	//Checking test case with all negative values for calculateColumnTotal
	@Test
	public void calculateColumnTotaWithNegativeValues() {
    ...
    public void CumulativePercentagesMaxInt() {
        ...
        // verify
        for (int i = 0; i < result.getItemCount(); i++) {
            assertEquals("Should return Max value", Integer.MAX_VALUE, result.getValue(i).doubleValue(), 1);
        }
    ...
    @Test
    public void calculateRowTotalNoValue() {
        // setup
        Mockery mockingContext = new Mockery();
        final Values2D values = mockingContext.mock(Values2D.class);
    ...
    @Test
    public void calculateRowTotalInvalidColumn() {
        // setup
        Mockery mockingContext = new Mockery();
        final Values2D values = mockingContext.mock(Values2D.class);
	...
	@Test
    public void CreateNumberArray2D_invalidInput() {
	double[][] input = null;
	createNumberArray2D(input);
	}
